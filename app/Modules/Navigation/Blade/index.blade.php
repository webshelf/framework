    ...
    <div class="webshelf-scope-menu">
        ...
        <ul class="list-unstyled">
            ...
            @foreach($menus as $menu)
                ...
                <li class="item">
                    <a href="{{ route('admin.navigation.group', ["group_id" => $menu->id]) }}" class="{{ Request::segment(4) == $menu->id ? 'active' : null }}">
    ...
    <form>
        <div class="searchbar">
            ...
            <div class="pull-right ml-2">
                <a href="{{ route('admin.navigation.create') }}" class="btn btn-create">Create Menu</a>
            </div>
        </div>
    </form>

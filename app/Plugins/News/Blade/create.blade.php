...
@section('content')
    ...
    <form action="{{ route('StoreNews') }}" method="post" id="form_page">

    <div class="portlet light ">
        <div class="portlet-title tabbable-line">
            <div class="caption">
                <i class="icon-share font-dark"></i>
                <span class="caption-subject font-dark bold uppercase">Add new Articles to your news posts.</span>
            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group date form_datetime" data-date="2012-12-21T15:25:00Z">
                                        <input type="text" name="defined_date" size="16" class="form-control">
